...
let currentNumber = parseInt(cartNumberElement.textContent || "0");

function addCartNumber() {
  currentNumber++;
  cartNumberElement.textContent = currentNumber;
}

function minusCartNumber() {
  if (currentNumber > 0) {
    currentNumber--;
    cartNumberElement.textContent = currentNumber;
  }
...
function clearCart() {
  currentNumber = 0;
  cartBody.innerHTML = `<h5 id="cartBody">Your cart is empty</h5>`;
}
